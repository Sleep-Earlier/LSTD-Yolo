...
if __name__ == '__main__':
    # model_path = '/root/autodl-fs/MyYolo/runs/distill/yolo11s-STFE-SPloss-bckd-mgd/weights/best.pt'
    model_path = '/root/autodl-fs/MyYolo/runs/train/yolo11s-4/weights/best.pt'
    # model_path = '/root/autodl-fs/MyYolo/runs/train/yolo11s/weights/best.pt'
    ...
    result = model.val(data='data.yaml',
                        ...
                        project='runs/val',
                        # name='fps-yolo11s-STFE-SPloss-bckd-mgd-TITAN-Xp',
                        name='yolo11s-4',
                        # name='fps-yolo11s-TITAN-Xp',
                       seed=1998
                        )
